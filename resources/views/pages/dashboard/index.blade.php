...
@section('main-content')
    {{-- bagian card dan list data --}}

    <div class="container-fluid">

        <div class="row">

            <div class="col-md-8 position-relative" style="overflow: auto;">

                <div class=" containers position-absolute slider-project draggable">
                        ...
                        <div class="card p-1 mx-2" style="width: 500px;">
                            ...
                            <div class="container-img position-relative">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"><img src="https://mdbcdn.b-cdn.net/img/new/slides/041.webp"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4"><label for=""
                                                    class='form-label badge bg-warning'>Kelas 10</label></div>

                                            <div class="col"><span><b>80</b> Anak</span><span
                                                    class="badge bg-info text-center mx-3"><i class='fa fa-info'></i></span>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4"><label for=""
                                                    class='form-label badge bg-success'>Kelas 11</label></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4"><label for=""
                                                    class='form-label badge bg-danger'>Kelas 12</label></div>
                        ...
                        <div class="card p-1" style="width: 500px; ">
                            ...
                            <div class="container-fluid p-2">
                                ...
                                <div class="container-jurusans d-inline">
                                    ...
                                    <span class="badge bg-primary">Projek 4</span> <span
                                        class="badge bg-primary ">MM</span>
                                ...
                                <div class="row pt-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"><span><b>80</b> Anak</span><span
                                                    class="badge bg-info text-center mx-3"><i
    ...
    {{-- tutup bagian card dan list data --}}
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            $(".slider-project").css({
                transform: `translateX(-${last3.width()}px)` // Ubah nilai translateX agar elemen card tetap di dalam layar
            })

            anime({
                targets: '.slider-project',
                translateX: 0, // Ubah nilai translateX ke 0 agar elemen card tetap di dalam layar
                duration: 1500, // Atur durasi animasi
                easing: 'easeInOutQuad', // Atur efek easing
                complete: () => {
