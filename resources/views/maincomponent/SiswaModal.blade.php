              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class='form-group mb-3' draggable='true'><label class='form-label'>jk</label><select class='form-select' name='jk'><option value='Laki-laki'>Laki-laki</option><option value='Perempuan'>Perempuan</option></select></div>
                    ...
                    <div class='form-group mb-3' draggable='true'><label class='form-label'>kelas</label><select class='form-select' name='kelas'><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option></select></div>
