...
.list-container-search li{
  display: block;
}

.list-container-search li a{
  padding: 5px;
  display: block;
}
</style>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="/pages/duniaindustri" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                  <div data-i18n="Basic">Dunia Industri</div>
                </a>
              </li>
              <li class="menu-item">
            ...
            <li class="menu-item">
              ...
              @if(Auth::guard('student')->check())
                <li class="menu-item">
                  <a href="{{url('/pages/profil')}}" class="menu-link">Profil</a>
                </li>
              @endif
                <li class="menu-item">
                  <a href="pages-account-settings-account.html" onclick="e.preventDefault()" class="menu-link logout-button">
                  Keluar
                  </a>
...
<script src="{{asset('/js copy/multiselect-dropdown.js')}}"></script>
<script>
  $(document).ready(function(e){
    $(document).click(function(e){
      $(".container-search-siswa").hide();
    })
